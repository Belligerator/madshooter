...
class SummonerSoldier extends BaseEnemy {
  ...
  static const double _hitboxWidth = 112.0;
  static const double _hitboxHeight = 120.0;
  ...
  SummonerSoldier({
    ...
    super.abilities = const [],
         ...
         spritePath: 'enemies/Enemy_Tank_Base.webp', // Using tank sprite
